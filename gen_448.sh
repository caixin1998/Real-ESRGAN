...
for i in {00..14}
  do
    ...
    CUDA_VISIBLE_DEVICES=`expr $i % 4` python inference_realesrgan.py -i /home/caixin/GazeData/MPIIFaceGaze/Image/p$i/face -o /data1/GazeData/MPIIRes/$1\_$2_448/Image/p$i/face --version $1  --iter $2 --sothis $3  --fp32 --size 448 &
...
wait
cp  -r /home/caixin/GazeData/MPIIFaceGaze/Label /data1/GazeData/MPIIRes/$1\_$2_448
cp -r /data1/GazeData/MPIIRes/$1\_$2_448 /home1/caixin/SothisAI/GazeData/MPIIRes
