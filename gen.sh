...
for i in {00..14}
  do
    ...
    CUDA_VISIBLE_DEVICES=`expr $i % $degree` python inference_realesrgan.py -i /home/caixin/GazeData/MPIIFaceGaze/Image/p$i/face -o /data1/GazeData/MPIIRes/$v\_$iter/Image/p$i/face -v $1  --iter $2 --sothis $3  &
